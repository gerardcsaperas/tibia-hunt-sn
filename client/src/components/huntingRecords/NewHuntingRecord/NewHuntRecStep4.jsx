...
const NewHuntRecStep4 = ({
    ...
    const specialEventForm = (
        <div className="form specialEvent">
    ...
    const difficultiesForm = (
        <div className="form difficulties">
            <div className="form-input-row">
                <select
                    name="difficulty"
                    value={difficulty}
    ...
    const huntPictureForm = (
        <div className="form">
            ...
            {picture && (
                <img src={picture} alt="chosen" style={{ height: "100px" }} />
            )}
        </div>
    );
    ...
    const content = (
        <Fragment>
            ...
            <div className="buttons_NHR">
                <button
                    className={!saving ? "button" : "disabled-button"}
                    onClick={previous}
                >
                    Back
                </button>
