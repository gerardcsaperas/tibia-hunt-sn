...
function HuntDetails() {
    ...
    const getHuntDetails = async () => {
        try {
            ...
            const response = await axios.get(
                `${API_URL}/huntingRecord/${recordID}`,
                config
            );
    ...
    const handleHuntingRecordDislike = () => {
        ...
        let dislikesArray = huntDetails.dislikes;
        uidDislikesIndex === -1
            ? dislikesArray.push(uid)
            : dislikesArray.splice(uidIndex, 1);
        ...
        if (vocation === "Paladin" || vocation === "RP") {
            return (
                <p>
                    <img
                        className="inline-img"
                        src={`../images/Distance_Weapons/Spear.jpg`}
                    />
                    {skills.distanceFighting}
                    <img
                        className="inline-img"
                        src={`../images/Shields/Dwarven_Shield.jpg`}
                    />
                    {skills.shielding}
                </p>
            );
            ...
            <Fragment>
                ...
                <div className="buttons__box">
                    ...
                    <button
                        ...
                        onClick={() => deleteHuntingRecord(_id)}
                    >
                        Delete
                    </button>
                </div>
        ...
        return (
            <div id="huntDetails">
                <p className="createdAt">
                    {new Date(createdAt).toString().slice(0, 34)}
                </p>
                {authenticated && (
                    <LikeButtons
                ...
                {huntUser._id === uid && (
                    <div className="delete-edit__box">
                        ...
                        <i
                            className="fas fa-trash delete-hunting-record"
                ...
                <div className="leftOrganiser">
                    <div className="userInformation">
                        <img
                            src={huntUser.avatar || "/images/default_user.jpg"}
                            alt="profilePic"
                        ></img>
                    ...
                    <div className="details__box">
                        ...
                        <div className="infoLight">
                            ...
                            <p>
                                <img
                                    className="inline-img"
                                    src={`../images/Spellbooks/Spellbook.jpg`}
                                />
                    ...
                    {/*-- Team --*/}
                    <SmallTable title="Team" data={team} marginTop={"20px"} />
                ...
                <div className="rightOrganiser">
                    <div className="lootPicDetail">
                        <a href={huntPicture} target="_blank">
                            <img
                                src={`${huntPicture}`}
                                alt="hunt picture"
                            ></img>
    ...
    return (
        <ContentBox
            ...
            width="1200px"
            title={
                huntDetails && huntDetails.spot
                    ? `${huntDetails.spot.city}, ${huntDetails.spot.name}`
                    : "Undefined"
            }
            content={content}
        ></ContentBox>
