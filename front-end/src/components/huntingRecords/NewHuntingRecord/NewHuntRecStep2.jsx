...
const NewHuntRecStep2 = ({ navigation, supplies, setSupplies, ammunition, setAmmunition, setExpRatio, setExpH, setProfitH }) => {
		...
		<div className="form supplies">
			<div className="form-input-row">
				...
				<div className="flex-row">
					...
					/>
					<i className="fas fa-plus-circle" onClick={() => setSupplies(supplies.concat(selectedSupply))} />
				</div>
			</div>
			<div className="form-input-row">
				...
				<div className="flex-row">
					...
					<input
						...
						min="1"
						onChange={(e) =>
							setSelectedAmmunition({ ...selectedAmmunition, [e.target.name]: e.target.value })}
					/>
					<i className="fas fa-plus-circle" onClick={() => setAmmunition(ammunition.concat(selectedAmmunition))} />
				</div>
			</div>
			<div className="form-input-row" className="supply-images__container">
				{
					supplies && (
	...
	const experienceForm = <div className="form experience">
		<div className="form-input-row">
			<label>Exp Ratio</label>
			<select name="expRatio" onChange={(e) => setExpRatio(e.target.value)}>
				<option value={1}>100%</option>
				<option value={1.5} defaultValue>150% Happy Hour</option>
	...
	const lootForm = <div className="form loot">
		<div className="form-input-row">
